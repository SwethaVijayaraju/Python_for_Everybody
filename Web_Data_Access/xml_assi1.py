...
# Actual data: http://py4e-data.dr-chuck.net/comments_673919.xml (Sum ends with 14)
...
# The closest sample code that shows how to parse XML is geoxml.py. But since the nesting of the elements in our data
...
# also work from the top of the XML down to the comments node, then loop through the child nodes of the comments node.
